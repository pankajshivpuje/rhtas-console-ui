  ...
  services: [
    ...
    },
    {
      ...
      drillDown: {
        ...
        impactMessage:
          "Last successful probe 38 minutes ago. 47 consecutive failures. New certificate issuance is blocked.",
        ...
        failingChecks: [
          {
            name: "TCP connect to fulcio.tas.internal:443",
            detail: "connection refused · 47 consecutive",
            severity: "danger",
          },
    ...
    },
    {
      ...
      drillDown: {
        ...
        impactMessage:
          "Rekor latency has exceeded the 2s threshold. Log entries may be delayed. Verification still functional.",
    ...
    },
    {
      ...
      drillDown: {
        ...
        impactMessage:
          "TUF root metadata has expired. Clients cannot verify trust anchors. Signature verification will fail.",
        lastSuccessfulProbe: "14 hours ago",
        consecutiveFailures: 168,
        probeHistory: [...(Array(6).fill("success") as ProbeStatus[]), ...(Array(14).fill("danger") as ProbeStatus[])],
        failingChecks: [
